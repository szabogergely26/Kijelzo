...
"""
Kijelző-profilváltás logikája (KScreen/kscreen-doctor alapon).

Ez a modul szándékosan NEM függ Qt-től (sem PyQt5-től, sem PySide6-tól) —
a GUI (main_window.py) és a headless CLI (cli.py) is ezt a modult hívja.
Ez teszi lehetővé, hogy a GUI-t PySide6-ra váltsuk anélkül, hogy a
profilváltás logikájához hozzá kellene nyúlni.
